...
/*
AIApiService Request from AI a response for the given input
...
func (a *AIApiService) EliControllerGenerateEliResponse(ctx context.Context, body AiGenerateRequestDto) (AiGenerateResponseDto, *http.Response, error) {
	var (
		...
		localVarReturnValue AiGenerateResponseDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v2/ai/generate"
