...
**GuiSettings** | [***AllOfVmInstanceGroupDtoGuiSettings**](AllOfVmInstanceGroupDtoGuiSettings.md) | GUI settings for the VM Instance Group. This is a JSON object. | [optional] [default to null]
