...
type VMTypesApiService service
/*
VMTypesApiService Creates a VM Type
Creates a VM Type
...
func (a *VMTypesApiService) InventoryController1CreateVMType(ctx context.Context, body CreateVmTypeDto) (VmTypeDto, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/v2/vm-types"
...
/*
VMTypesApiService Deletes a VM Type
Deletes a VM Type
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param vmTypeId
...
func (a *VMTypesApiService) InventoryController1DeleteVMType(ctx context.Context, vmTypeId float64) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v2/vm-types/{vmTypeId}"
...
/*
VMTypesApiService Get VM Type information
...
/*
VMTypesApiService Returns all VMs linked to the VM Type
...
func (a *VMTypesApiService) InventoryController1GetVMsByVMType(ctx context.Context, vmTypeId float64) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v2/vm-types/{vmTypeId}/vms"
	localVarPath = strings.Replace(localVarPath, "{"+"vmTypeId"+"}", fmt.Sprintf("%v", vmTypeId), -1)
...
/*
VMTypesApiService Updates VM Type information
