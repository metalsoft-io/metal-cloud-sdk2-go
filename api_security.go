...
/*
SecurityApiService Get available authentication providers
...
func (a *SecurityApiService) ListProviders(ctx context.Context) ([]AuthenticationProvider, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/v2/authentication/providers"
...
/*
SecurityApiService Updates authentication provider
Updates authentication provider
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The provider updates
 * @param name
@return []AuthenticationProvider
*/
func (a *SecurityApiService) UpdateProvider(ctx context.Context, body AuthenticationProviderUpdate, name string) ([]AuthenticationProvider, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v2/authentication/providers/{name}"
